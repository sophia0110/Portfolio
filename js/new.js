...
'<div class="item" >' +
'<div class="card" >' +
'<img class="cardImg" src="images/翻牌遊戲.gif" alt="">' +
...
"</div>"+
  '<div class="item">' +
  '<div class="card">' +
  '<img class="cardImg" src="images/手風琴動畫.gif" alt="">' +
  ...
  '<div class="item">' +
  '<div class="card">' +
  '<img class="cardImg" src="images/我的調色盤.gif" alt="">' +
  ...
  '<div class="item">' +
  '<div class="card">' +
  '<img class="cardImg" src="images/購物車價格加總.gif" alt="">' +
...
'<div class="item">' +
'<div class="card">' +
'<img class="cardImg" src="images/美髮網站切版.gif" alt="">' +
...
"</div>"+
  '<div class="item">' +
  '<div class="card">' +
  '<img class="cardImg" src="images/Bootstrap.gif" alt="">' +
